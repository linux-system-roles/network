    ...
    def __init__(self):
        ArgValidatorDict.__init__(self,
            ...
            nested = [
                ...
                ArgValidatorStr ('infiniband_transport_mode', enum_values = ['datagram', 'connected'], default_value = ArgValidator.MISSING), #deprecated
                ArgValidatorNum ('infiniband_p_key', val_min = -1, val_max = 0xFFFF, default_value = ArgValidator.MISSING), #deprecated
                ArgValidatorNum ('vlan_id', val_min = 0, val_max = 4094, default_value = ArgValidator.MISSING), #deprecated
                ArgValidator_DictIP(),
